...
export class Controller {
    ...
    private createGame(rows: number, cols: number): GameS25 {
        ...
        const teamA = new Team("Red", [ new PieceBlueHen("Red"), new PieceMinion("Red"), new PieceScrat("Red") ]);
        const teamB = new Team("Blue", [ new PieceBlueHen("Blue"), new PieceMinion("Blue"), new PieceScrat("Blue") ]);
